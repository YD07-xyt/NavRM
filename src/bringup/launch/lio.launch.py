...
# livox_ros2_config_path='src/livox_ros_driver2/config/MID360_config.json'
...
def generate_launch_description():
    ...
    pkg_terrain = get_package_share_directory('terrain_analysis')
    terrain_config = os.path.join(pkg_terrain, 'config', 'param.yaml')
    ...
    pkg_terrain_ext = get_package_share_directory('terrain_analysis_ext')
    terrain_ext_config = os.path.join(pkg_terrain_ext, 'config', 'param.yaml')

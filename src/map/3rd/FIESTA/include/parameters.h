...
#ifndef ESDF_TOOLS_INCLUDE_PARAMETERS_H
#define ESDF_TOOLS_INCLUDE_PARAMETERS_H
#include <Eigen/Eigen>
...
namespace fiesta {
    ...
    const Eigen::Vector3i dirs_[num_dirs_] = {Eigen::Vector3i(-1, 0, 0),
        ...
        Eigen::Vector3i(-2, 0, 0),
        Eigen::Vector3i(2, 0, 0),
        Eigen::Vector3i(0, -2, 0),
        Eigen::Vector3i(0, 2, 0),
        Eigen::Vector3i(0, 0, -2),
        Eigen::Vector3i(0, 0, 2)};
    ...
    struct Parameters {
        ...
        double depth_filter_max_dist_, depth_filter_min_dist_,
